...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "predict_house_price"
...
#define AI_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 19, 1, NULL), \
}
...
#define AI_NETWORK_IN_1_SIZE        (1 * 1 * 19)
...
#define AI_NETWORK_OUT_1_SIZE        (1 * 1 * 1)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (AI_NETWORK_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_NETWORK_N_NODES (22)
